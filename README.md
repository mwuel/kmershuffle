# kmershuffle
A small script counting k-mers given a bed file of short binding sites of RNA-binding proteins and z-scoring randomly shuffled k-mers of same length on the same genes.
